...
@section('content')
                    ...
                    <h5 class="mb-0">Opret Badge</h5>
            

                <div class="card-body">
                    <form method="POST" action="{{ route('onboarding.badges.store') }}" id="badgeForm">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            @include('onboarding::badges.includes.icon-select', ['selectedIcon' => old('icon')])
                        </div>

                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Opret Badge
                            </button>
                            <a href="{{ route('onboarding.badges.index') }}" class="btn btn-secondary">
                                Annuller
                            </a>
